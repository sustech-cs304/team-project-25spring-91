...
![make an account 1](./images/make%20an%20account%201.png)

![make an account 2](./images/make%20an%20account%202.png)
...
![make an account 3](./images/make%20an%20account%203.png)
...
![set goal page](./images/set-goal-page.png)
...
![set goal add 1](./images/set-goal-add%20%201.png)

Need to make changes? You can always **edit your existing workout plans** to better fit your evolving routine.

![set goal options](./images/set-goal-options.png)

![set goal edit](./images/set-goal-edit.png)
...
![completed add](./images/completed-add.png)
...
![completed edit](./images/completed-edit.png)
...
![diet page 1](./images/diet-page%201.png)
...
![diet calendar 1](./images/diet-calendar%201.png)
...
![diet view meal](./images/diet-view-meal.png)
...
![settings user data](./images/settings-user-data.png)
...
![make an account 1 1](./images/make%20an%20account%201%201.png)

![make an account 2 1](./images/make%20an%20account%202%201.png)

They will take you to the page shown below, where you can fill in your details to sign up for an account. After entering your information into each field, select the 'Regular User' role to log into the app as a user. For the 'Gym Owner' role, refer to the '[[#Sign up as a Gym Owner]]' section. Finalize your account by clicking the 'Create Account' button.

![Example Image](./images/make-an-account-3-gym-owner.png)
